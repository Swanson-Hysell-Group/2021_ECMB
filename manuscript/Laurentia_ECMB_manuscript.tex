...
{\BBOQ}\APACrefatitle {{Depth of emplacement and tilting of the Middle
  Proterozoic (1470 Ma) Wolf River batholith, Wisconsin}:
  $^{40}${A}r/$^{39}${A}r thermochronologic constraints} {{Depth of emplacement
  and tilting of the Middle Proterozoic (1470 Ma) Wolf River batholith,
  Wisconsin}: $^{40}${A}r/$^{39}${A}r thermochronologic constraints}.{\BBCQ}
\newblock
